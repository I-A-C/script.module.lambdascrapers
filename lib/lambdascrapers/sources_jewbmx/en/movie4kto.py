...
# Removed but not actually broken
# movie4k.unblocked.mx loads to movie4k.unblocked.gdn
# movie4k.tv and movie4k.to load to movie4k.io
# Note could break this down into two scrapers for the hell of it...
# (1- .io - .tv - .to. ) then (2- .st - .lol - .gdn - .mx)

class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domains = ['movie4kto.st','movie4k.io','movie4k.unblocked.lol','movie4k.unblocked.gdn'] 
        ...
        try:
            for domain in self.domains:
                try:
                    ...
                    if r and 'movie4kto.st' in r[0].attrs.get('content').lower():
                        return url
                except:
                    pass
        except:
