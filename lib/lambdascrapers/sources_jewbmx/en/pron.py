...
#######################################################################
 ...
 # ----------------------------------------------------------------------------
#######################################################################
# pron.tv goes to mypron.tv but didnt add it in.
# this all appears to be a porn scraper or atleast the domains are now lol.
# someone else can mess with this, i dont want cyber aids lol
...
class source:
    def __init__(self):
        self.priority = 0
        self.language = ['en']
        self.domains = ['pron.tv'] # mypron.tv
