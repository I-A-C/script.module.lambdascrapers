...
class source:
    ...
    def tvshow(self, imdb, tvdb, tvshowtitle, localtvshowtitle, aliases, year):
        ...
        try:
            ...
            log_utils.log('tvshow: url: {}'.format(url))
            return url
    ...
    def episode(self, url, imdb, tvdb, title, premiered, season, episode):
        log_utils.log("Inside episode........................")
        # log_utils.log(url)
        # log_utils.log(imdb)
        # log_utils.log(tvdb)
        # log_utils.log(title)
        # log_utils.log(premiered)
        # log_utils.log(season)
        # log_utils.log(episode)
        ...
        log_utils.log("film_id: {}".format(film_id))
